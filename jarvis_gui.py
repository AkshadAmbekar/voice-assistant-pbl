...
class VoiceAssistantGUI:
    def __init__(self, root):
        ...
        # starting-indicator-update-thread
        ...
        while self.running:
            ...
            if self.continuous_mode:
                if self.processing_command:
                    # Processing - yellow
                    current_state = "#f39c12"
                else:
                    # Active listening - green
                    current_state = "#2ecc71"
            else:
                # Hotword detection - gray
                current_state = "#cccccc"
            
            # update-UI-if-state-changes
...
if __name__ == "__main__":
    ...
    root.protocol("WM_DELETE_WINDOW", app.stop)  # window-closing
    root.mainloop()